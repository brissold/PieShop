...
namespace BethanPieShop.Migrations
{
    ...
    [Migration("20191127194948_Placed")]
    partial class Placed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BethanPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BethanPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BethanPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethanPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BethanPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("BethanPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BethanPieShop.Models.Pie", b =>
                {
                    b.HasOne("BethanPieShop.Models.Category", "Category")
                        .WithMany("Pies")
